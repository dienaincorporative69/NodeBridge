...
#[derive(Debug)]
pub struct NodeBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NodeBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NodeBridge processing");
    
    let mut processor = NodeBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NodeBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NodeBridgeProcessor::new(false);
